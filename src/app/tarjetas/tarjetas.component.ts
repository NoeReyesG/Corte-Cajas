...
export class TarjetasComponent implements OnInit{
  ...
  buttonColor = {
    sky: ' border text-sky-400 placeholder-sky-500 text-base font-semibold rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-28 p-1.5 bg-gray-700 border-sky-500',
    cyan: 'border text-cyan-400 placeholder-cyan-500 text-base font-semibold rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-28 p-1.5 bg-gray-700 border-cyan-500',
    amber: 'border text-amber-400 placeholder-amber-500 text-base font-semibold rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-28 p-1.5 bg-gray-700 border-amber-500',
